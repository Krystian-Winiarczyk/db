...
--
-- Host: 127.0.0.1
-- Czas generowania: 19 Wrz 2021, 20:07
...
(42, 'Ipsam dolores asperiores eveniet quaerat qui aliquid velit id.', 'rerum sit excepturi', '936.00', 'http://placeimg.com/640/480/cats', '0', 12, '2021-09-18 14:14:30', '2021-09-18 14:14:30'),
...
(46, 'Ab temporibus ut eveniet enim sit fuga sit quam.', 'nihil consectetur totam', '588.00', 'http://placeimg.com/640/480/cats', '0', 18, '2021-09-18 14:14:31', '2021-09-18 14:14:31'),
...
-- Wyzwalacze `courses`
--
DROP TRIGGER IF EXISTS `generateNotificationOnInsert`;
DELIMITER $$
...
(3, 14, 47, '921.00', '23984179412987', '366', 'Tester', '09/2025', '2021-09-19 14:02:45'),
...
-- Wyzwalacze `payments`
--
DROP TRIGGER IF EXISTS `addUserCours`;
DELIMITER $$
...
(1, 12, 13, '4', '2021-09-17 09:06:29'),
(2, 12, 13, '6', '2021-09-17 09:11:58');

--
-- Wyzwalacze `ratings`
--
DROP TRIGGER IF EXISTS `updateCoursRating`;
DELIMITER $$
...
SET courses.rating = (SELECT ROUND(AVG(ratings.starts), 1) as stars FROM `ratings` WHERE ratings.cours_id = 12)
